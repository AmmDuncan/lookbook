...
> **DELIVERED 2026-08-09 → `Surface Relationship Studies.html`** (all 8 relations + the header sub-axis + greyscale proof). Original ask below, kept for the reasoning.
...
| **Surface relationship** ⭐ — how the NAV surface relates to the CONTENT surface, nav + page content held identical: bordered / same-level / sunken-nav+raised-content / floating content / inset nav / ink rail + detached / full-bleed / two-tone · plus header position vs the split (spanning / over-content / none) · plus an A×B combination guide and a greyscale proof strip | `Surface Relationship Studies.html` |
